...
- [GitHub](https://github.com/farridav/django-jazzmin) (👨‍💻 76 · 🔀 300 · 📦 17K · 📋 300 - 43% open · ⏱️ 11.01.2025):
	...
	```
- [PyPi](https://pypi.org/project/django-jazzmin) (📥 390K / month):
	```
...
- [GitHub](https://github.com/sehmaschine/django-grappelli) (👨‍💻 91 · 🔀 650 · 📦 6.9K · 📋 740 - 1% open · ⏱️ 28.04.2025):
...
- [GitHub](https://github.com/viewflow/django-material) (👨‍💻 4 · 🔀 410 · 📦 1.9K · 📋 420 - 4% open · ⏱️ 30.06.2025):
	...
	```
- [PyPi](https://pypi.org/project/django-material) (📥 19K / month):
	```
	pip install django-material
	```
</details>
<details><summary><b><a href="https://github.com/otto-torino/django-baton">django-baton</a></b> (🥉25 ·  ⭐ 970) - A cool, modern and responsive django admin application based on bootstrap 5 that brings AI to the Django admin -.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/django-admin-tools/django-admin-tools) (👨‍💻 82 · 🔀 110 · 📦 1.6K · 📋 80 - 23% open · ⏱️ 10.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-admin-tools) (📥 130K / month):
	```
...
- [GitHub](https://github.com/django-import-export/django-import-export) (👨‍💻 240 · 🔀 780 · 📦 130K · 📋 1.1K - 2% open · ⏱️ 31.10.2025):

	```
	git clone https://github.com/django-import-export/django-import-export
	```
- [PyPi](https://pypi.org/project/django-import-export) (📥 2M / month):
	```
	pip install django-import-export
	```
</details>
<details><summary><b><a href="https://github.com/jrief/django-admin-sortable2">django-admin-sortable2</a></b> (🥈26 ·  ⭐ 850) - Generic drag-and-drop ordering for objects in the Django admin interface. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/jrief/django-admin-sortable2) (👨‍💻 90 · 🔀 180 · 📦 2.9K · 📋 240 - 20% open · ⏱️ 15.05.2025):
	...
	```
- [PyPi](https://pypi.org/project/django-admin-sortable2) (📥 950K / month):
	```
...
- [GitHub](https://github.com/jazzband/django-admin-sortable) (👨‍💻 81 · 🔀 130 · 📦 750 · 📋 140 - 7% open · ⏱️ 13.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/django-admin-sortable) (📥 47K / month):
	```
...
- [GitHub](https://github.com/TrangPham/django-admin-confirm) (👨‍💻 10 · 🔀 17 · 📥 3 · 📋 36 - 33% open · ⏱️ 06.05.2025):

	```
	git clone https://github.com/trangpham/django-admin-confirm
	```
- [PyPi](https://pypi.org/project/django-admin-confirm) (📥 43K / month):
	```
...
- [GitHub](https://github.com/django-extensions/django-extensions) (👨‍💻 600 · 🔀 1.1K · 📦 270K · 📋 930 - 18% open · ⏱️ 03.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/django-extensions) (📥 8.3M / month):
	```
	pip install django-extensions
	```
</details>
<details><summary><b><a href="https://github.com/Archmonger/django-dbbackup">django-dbbackup</a></b> (🥈30 ·  ⭐ 1.1K) - Backup and restore your Django database and media. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/Archmonger/django-dbbackup) (👨‍💻 81 · 🔀 200 · 📥 5 · 📦 2.6K · 📋 310 - 2% open · ⏱️ 03.09.2025):

	```
	git clone https://github.com/jazzband/django-dbbackup
	```
- [PyPi](https://pypi.org/project/django-dbbackup) (📥 240K / month):
	```
	pip install django-dbbackup
	```
</details>
<details><summary><b><a href="https://github.com/django-commons/django-typer">django-typer</a></b> (🥉24 ·  ⭐ 230) - Use Typer (type hints) to define the interface for your Django management commands. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/django-commons/django-typer) (👨‍💻 8 · 🔀 4 · 📥 13 · 📦 73 · 📋 160 - 10% open · ⏱️ 27.10.2025):

	```
	git clone https://github.com/bckohan/django-typer
	```
- [PyPi](https://pypi.org/project/django-typer) (📥 49K / month):
	```
	pip install django-typer
	```
</details>
<details><summary><b><a href="https://github.com/django-commons/django-click">django-click</a></b> (🥉21 ·  ⭐ 290) - Write Django management command using the click CLI library. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/django-commons/django-click) (👨‍💻 13 · 🔀 21 · 📦 360 · 📋 18 - 44% open · ⏱️ 27.02.2025):

	```
	git clone https://github.com/GaretJax/django-click
	```
- [PyPi](https://pypi.org/project/django-click) (📥 61K / month):
	```
...
- [GitHub](https://github.com/adamchainz/django-rich) (👨‍💻 6 · 🔀 12 · 📦 200 · 📋 13 - 23% open · ⏱️ 07.10.2025):
...
- [GitHub](https://github.com/Suor/django-cacheops) (👨‍💻 72 · 🔀 220 · 📦 1.6K · 📋 350 - 4% open · ⏱️ 15.10.2025):

	```
	git clone https://github.com/Suor/django-cacheops
	```
- [PyPi](https://pypi.org/project/django-cacheops) (📥 390K / month):
	```
...
- [GitHub](https://github.com/noripyt/django-cachalot) (👨‍💻 39 · 🔀 150 · 📦 1K · 📋 170 - 16% open · ⏱️ 17.04.2025):

	```
	git clone https://github.com/noripyt/django-cachalot
	```
- [PyPi](https://pypi.org/project/django-cachalot) (📥 150K / month):
	```
...
- [GitHub](https://github.com/jazzband/dj-database-url) (👨‍💻 73 · 🔀 200 · 📦 310K · 📋 100 - 4% open · ⏱️ 22.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/dj-database-url) (📥 3.6M / month):
	```
	pip install dj-database-url
	```
</details>
<details><summary><b><a href="https://github.com/jazzband/django-constance">django-constance</a></b> (🥈33 ·  ⭐ 1.8K) - Dynamic Django settings. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jazzband/django-constance) (👨‍💻 160 · 🔀 300 · 📦 2.4K · 📋 320 - 8% open · ⏱️ 21.10.2025):

	```
	git clone https://github.com/jazzband/django-constance
	```
- [PyPi](https://pypi.org/project/django-constance) (📥 570K / month):
	```
...
- [GitHub](https://github.com/jazzband/django-configurations) (👨‍💻 74 · 🔀 140 · 📦 3.4K · 📋 210 - 26% open · ⏱️ 18.11.2024):
	...
	```
- [PyPi](https://pypi.org/project/django-configurations) (📥 350K / month):
	```
...
- [GitHub](https://github.com/fabiocaccamo/django-extra-settings) (👨‍💻 13 · 🔀 32 · 📦 110 · 📋 41 - 12% open · ⏱️ 30.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/django-extra-settings) (📥 43K / month):
	```
...
- [GitHub](https://github.com/ets-labs/python-dependency-injector) (👨‍💻 39 · 🔀 330 · 📦 5.2K · 📋 630 - 31% open · ⏱️ 19.09.2025):

	```
	git clone https://github.com/ets-labs/python-dependency-injector
	```
- [PyPi](https://pypi.org/project/dependency-injector) (📥 3.3M / month):
	```
	pip install dependency-injector
	```
</details>
<details><summary><b><a href="https://github.com/reagento/dishka">dishka</a></b> (🥇29 ·  ⭐ 900) - Cute dependency injection (DI) framework for Python with agreeable API and everything you need. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/reagento/dishka) (👨‍💻 67 · 🔀 91 · 📦 660 · 📋 170 - 26% open · ⏱️ 31.10.2025):

	```
	git clone https://github.com/reagento/dishka
	```
- [PyPi](https://pypi.org/project/dishka) (📥 130K / month):
	```
	pip install dishka
	```
</details>
<details><summary><b><a href="https://github.com/Lancetnik/FastDepends">FastDepends</a></b> (🥈27 ·  ⭐ 460) - FastDepends - FastAPI Dependency Injection system extracted from FastAPI and cleared of all HTTP logic. Async and sync.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Lancetnik/FastDepends) (👨‍💻 17 · 🔀 31 · 📦 670 · 📋 44 - 22% open · ⏱️ 27.10.2025):

	```
	git clone https://github.com/lancetnik/FastDepends
	```
- [PyPi](https://pypi.org/project/fast-depends) (📥 740K / month):
	```
...
- [GitHub](https://github.com/python-injector/injector) (👨‍💻 33 · 🔀 92 · 📦 3K · 📋 150 - 29% open · ⏱️ 03.10.2025):

	```
	git clone https://github.com/python-injector/injector
	```
- [PyPi](https://pypi.org/project/injector) (📥 2.9M / month):
	```
...
- [GitHub](https://github.com/hynek/svcs) (👨‍💻 10 · 🔀 22 · 📦 320 · 📋 21 - 4% open · ⏱️ 15.10.2025):

	```
	git clone https://github.com/hynek/svcs
	```
- [PyPi](https://pypi.org/project/svcs) (📥 4.3M / month):
	```
	pip install svcs
	```
</details>
<details><summary><b><a href="https://github.com/ivankorobkov/python-inject">python-inject</a></b> (🥈25 ·  ⭐ 740) - Python dependency injection. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
<details><summary><b><a href="https://github.com/meadsteve/lagom">lagom</a></b> (🥈23 ·  ⭐ 330) - Autowiring dependency injection container for python 3. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/meadsteve/lagom) (👨‍💻 13 · 🔀 19 · 📦 480 · 📋 140 - 19% open · ⏱️ 28.07.2025):

	```
	git clone https://github.com/meadsteve/lagom
	```
- [PyPi](https://pypi.org/project/lagom) (📥 190K / month):
	```
	pip install lagom
	```
</details>
...
- [GitHub](https://github.com/maldoinc/wireup) (👨‍💻 10 · 🔀 17 · 📦 25 · 📋 61 - 22% open · ⏱️ 28.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/wireup) (📥 19K / month):
	```
	pip install wireup
	```
</details>
...
<details><summary><b><a href="https://github.com/modern-python/that-depends">that-depends</a></b> (🥉21 ·  ⭐ 230) - Simple Dependency injection framework for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/modern-python/that-depends) (👨‍💻 15 · 🔀 14 · 📥 230 · 📦 16 · 📋 75 - 6% open · ⏱️ 17.10.2025):

	```
	git clone https://github.com/modern-python/that-depends
	```
- [PyPi](https://pypi.org/project/that-depends) (📥 27K / month):
	```
	pip install that-depends
	```
</details>
<details><summary><b><a href="https://github.com/bobthemighty/punq">punq</a></b> (🥉20 ·  ⭐ 400) - An IoC container for Python 3.8+. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/bobthemighty/punq) (👨‍💻 12 · 🔀 18 · 📦 390 · 📋 47 - 31% open · ⏱️ 06.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/punq) (📥 110K / month):
	```
	pip install punq
	```
</details>
...
- [GitHub](https://github.com/adriangb/di) (👨‍💻 9 · 🔀 14 · 📦 170 · 📋 49 - 18% open · ⏱️ 09.10.2023):
	...
	```
- [PyPi](https://pypi.org/project/di) (📥 27K / month):
	```
	pip install di
	```
</details>
...
- [GitHub](https://github.com/Neoteroi/rodi) (👨‍💻 10 · 🔀 17 · 📦 310 · 📋 22 - 18% open · ⏱️ 12.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/rodi) (📥 42K / month):
	```
	pip install rodi
	```
</details>
...
- [GitHub](https://github.com/illuin-tech/opyoid) (👨‍💻 6 · 🔀 6 · 📦 30 · ⏱️ 14.10.2025):

	```
	git clone https://github.com/illuin-tech/opyoid
	```
- [PyPi](https://pypi.org/project/opyoid) (📥 7.1K / month):
	```
	pip install opyoid
	```
</details>
...
- [GitHub](https://github.com/modern-python/modern-di) (👨‍💻 6 · 🔀 4 · 📦 5 · 📋 34 - 5% open · ⏱️ 24.10.2025):

	```
	git clone https://github.com/modern-python/modern-di
	```
- [PyPi](https://pypi.org/project/modern-di) (📥 2.2K / month):
	```
...
- [GitHub](https://github.com/blubber/django_injector) (👨‍💻 7 · 🔀 7 · ⏱️ 09.04.2024):
	...
	```
- [PyPi](https://pypi.org/project/django_injector) (📥 3.5K / month):
	```
...
- [GitHub](https://github.com/django-commons/django-debug-toolbar) (👨‍💻 320 · 🔀 960 · 📥 320 · 📦 110K · 📋 990 - 6% open · ⏱️ 30.10.2025):

	```
	git clone https://github.com/jazzband/django-debug-toolbar
	```
- [PyPi](https://pypi.org/project/django-debug-toolbar) (📥 5.9M / month):
	```
...
- [GitHub](https://github.com/gauge-sh/tach) (👨‍💻 20 · 🔀 70 · 📦 78 · 📋 130 - 17% open · ⏱️ 04.06.2025):
...
- [GitHub](https://github.com/adamchainz/django-browser-reload) (👨‍💻 7 · 🔀 34 · 📦 6.8K · 📋 43 - 32% open · ⏱️ 07.10.2025):

	```
	git clone https://github.com/adamchainz/django-browser-reload
	```
- [PyPi](https://pypi.org/project/django-browser-reload) (📥 240K / month):
	```
...
- [GitHub](https://github.com/adamchainz/django-harlequin) (👨‍💻 5 · 🔀 4 · 📦 8 · ⏱️ 07.10.2025):
...
- [GitHub](https://github.com/garden-io/garden) (👨‍💻 120 · 🔀 290 · 📥 4M · 📦 3 · 📋 1.7K - 12% open · ⏱️ 31.10.2025):
...
- [GitHub](https://github.com/typeddjango/django-stubs) (👨‍💻 320 · 🔀 430 · 📦 14K · 📋 840 - 21% open · ⏱️ 31.10.2025):

	```
	git clone https://github.com/typeddjango/django-stubs
	```
- [PyPi](https://pypi.org/project/django-stubs) (📥 4.1M / month):
	```
...
- [GitHub](https://github.com/typeddjango/djangorestframework-stubs) (👨‍💻 88 · 🔀 120 · 📦 3.9K · 📋 160 - 33% open · ⏱️ 27.10.2025):
...
- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 68 · 🔀 750 · 📦 140K · 📋 1.1K - 20% open · ⏱️ 26.10.2025):
...
<details><summary><b><a href="https://github.com/hynek/structlog">structlog</a></b> (🥈37 ·  ⭐ 4.3K · 📈) - Simple, powerful, and fast logging for Python. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/jrobichaud/django-structlog) (👨‍💻 25 · 🔀 38 · 📦 970 · ⏱️ 27.10.2025):

	```
	git clone https://github.com/jrobichaud/django-structlog
	```
- [PyPi](https://pypi.org/project/django-structlog) (📥 1.2M / month):
	```
...
- [GitHub](https://github.com/snok/django-guid) (👨‍💻 15 · 🔀 28 · 📦 300 · 📋 31 - 16% open · ⏱️ 22.07.2025):

	```
	git clone https://github.com/snok/django-guid
	```
- [PyPi](https://pypi.org/project/django-guid) (📥 150K / month):
	```
...
<details><summary><b><a href="https://github.com/pydantic/logfire">logfire</a></b> (🥇35 ·  ⭐ 3.7K) - Uncomplicated Observability for Python and beyond!. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pydantic/logfire) (👨‍💻 73 · 🔀 180 · 📦 1.9K · 📋 470 - 29% open · ⏱️ 30.10.2025):

	```
	git clone https://github.com/pydantic/logfire
	```
- [PyPi](https://pypi.org/project/logfire) (📥 4.5M / month):
	```
	pip install logfire
	```
</details>
...
- [GitHub](https://github.com/django-commons/django-prometheus) (👨‍💻 62 · 🔀 240 · 📦 4.3K · 📋 160 - 40% open · ⏱️ 14.10.2025):

	```
	git clone https://github.com/korfuri/django-prometheus
	```
- [PyPi](https://pypi.org/project/django-prometheus) (📥 1.8M / month):
	```
...
- [GitHub](https://github.com/highlight/highlight) (👨‍💻 85 · 🔀 460 · 📦 420 · 📋 2.8K - 9% open · ⏱️ 28.10.2025):

	```
	git clone https://github.com/highlight/highlight
	```
</details>
<details><summary><b><a href="https://github.com/Checkmk/checkmk">CheckMK</a></b> (🥉23 ·  ⭐ 2.1K) - Checkmk - Best-in-class infrastructure & application monitoring. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/Checkmk/checkmk) (👨‍💻 390 · 🔀 500 · ⏱️ 31.10.2025):
...
- [GitHub](https://github.com/pennersr/django-allauth) (👨‍💻 790 · 🔀 3K · 📦 270K · 📋 2.4K - 0% open · ⏱️ 31.10.2025):
...
- [GitHub](https://github.com/django-guardian/django-guardian) (👨‍💻 180 · 🔀 560 · 📦 7.6K · 📋 490 - 6% open · ⏱️ 21.10.2025):

	```
	git clone https://github.com/django-guardian/django-guardian
	```
- [PyPi](https://pypi.org/project/django-guardian) (📥 710K / month):
	```
...
- [GitHub](https://github.com/jazzband/django-two-factor-auth) (👨‍💻 110 · 🔀 440 · 📦 2.4K · 📋 390 - 22% open · ⏱️ 13.10.2025):

	```
	git clone https://github.com/jazzband/django-two-factor-auth
	```
- [PyPi](https://pypi.org/project/django-two-factor-auth) (📥 880K / month):
	```
...
- [GitHub](https://github.com/django-oauth/django-oauth-toolkit) (👨‍💻 270 · 🔀 780 · 📦 12K · 📋 870 - 21% open · ⏱️ 03.10.2025):
...
- [GitHub](https://github.com/python-social-auth/social-app-django) (👨‍💻 340 · 🔀 380 · 📦 52K · 📋 270 - 9% open · ⏱️ 31.10.2025):
...
<details><summary><b><a href="https://github.com/juanifioren/django-oidc-provider">django-oidc-provider</a></b> (🥈29 ·  ⭐ 450) - OpenID Connect and OAuth2 provider implementation for the Django framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/django-cas-ng/django-cas-ng) (👨‍💻 89 · 🔀 160 · 📥 730 · 📦 640 · 📋 160 - 1% open · ⏱️ 08.10.2025):
...
- [GitHub](https://github.com/django-otp/django-otp) (👨‍💻 52 · 🔀 110 · 📦 4.4K · 📋 88 - 13% open · ⏱️ 25.10.2025):
...
- [GitHub](https://github.com/snok/django-auth-adfs) (👨‍💻 49 · 🔀 100 · 📦 180 · 📋 220 - 16% open · ⏱️ 23.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/django-auth-adfs) (📥 92K / month):
	```
...
- [GitHub](https://github.com/valohai/django-allauth-2fa) (👨‍💻 34 · 🔀 51 · 📥 30 · 📦 250 · 📋 74 - 17% open · ⏱️ 11.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/django-allauth-2fa) (📥 51K / month):
	```
...
- [GitHub](https://github.com/idlesign/django-oauthost) (👨‍💻 2 · 📦 5 · 📋 3 - 33% open · ⏱️ 04.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/django-oauthost) (📥 140 / month):
	```
...
- [GitHub](https://github.com/dfunckt/django-rules) (👨‍💻 33 · 🔀 140 · 📋 120 - 25% open · ⏱️ 11.10.2025):
...
- [GitHub](https://github.com/celery/celery) (👨‍💻 1.4K · 🔀 4.7K · 📦 180K · 📋 5.2K - 13% open · ⏱️ 29.10.2025):
...
- [GitHub](https://github.com/rq/rq) (👨‍💻 340 · 🔀 1.4K · 📦 21K · 📋 1.2K - 18% open · ⏱️ 11.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/rq) (📥 3.8M / month):
	```
	pip install rq
	```
</details>
<details><summary><b><a href="https://github.com/Bogdanp/dramatiq">dramatiq</a></b> (🥈33 ·  ⭐ 4.9K) - A fast and reliable background task processing library for Python 3. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/Bogdanp/dramatiq) (👨‍💻 130 · 🔀 340 · 📥 56 · 📦 1.6K · 📋 430 - 9% open · ⏱️ 28.10.2025):

	```
	git clone https://github.com/Bogdanp/dramatiq
	```
- [PyPi](https://pypi.org/project/dramatiq) (📥 810K / month):
	```
...
- [GitHub](https://github.com/celery/django-celery-beat) (👨‍💻 140 · 🔀 460 · 📥 16 · 📦 29K · 📋 470 - 23% open · ⏱️ 27.10.2025):
...
- [GitHub](https://github.com/rq/django-rq) (👨‍💻 140 · 🔀 290 · 📦 4.2K · 📋 370 - 26% open · ⏱️ 13.10.2025):
...
<details><summary><b><a href="https://github.com/pytransitions/transitions">transitions</a></b> (🥇33 ·  ⭐ 6.3K) - A lightweight, object-oriented finite state machine implementation in Python with many extensions. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/jazzband/django-fsm-log">django-fsm-log</a></b> (🥈25 ·  ⭐ 250) - Automatic logging for Django FSM. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/jazzband/django-fsm-log) (👨‍💻 28 · 🔀 76 · 📦 160 · 📋 49 - 24% open · ⏱️ 11.06.2025):
	...
	```
- [PyPi](https://pypi.org/project/django-fsm-log) (📥 67K / month):
	```
...
- [GitHub](https://github.com/gadventures/django-fsm-admin) (👨‍💻 33 · 🔀 94 · 📦 380 · 📋 39 - 48% open · ⏱️ 25.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/django-fsm-admin) (📥 10K / month):
	```
...
- [GitHub](https://github.com/encode/django-rest-framework) (👨‍💻 1.5K · 🔀 6.9K · 📦 850K · 📋 3.9K - 1% open · ⏱️ 30.10.2025):
...
- [GitHub](https://github.com/jazzband/djangorestframework-simplejwt) (👨‍💻 140 · 🔀 640 · 📋 510 - 22% open · ⏱️ 03.10.2025):

	```
	git clone https://github.com/jazzband/djangorestframework-simplejwt
	```
- [PyPi](https://pypi.org/project/djangorestframework-simplejwt) (📥 4.7M / month):
	```
...
- [GitHub](https://github.com/yezyilomo/django-restql) (👨‍💻 6 · 🔀 44 · 📦 330 · 📋 110 - 21% open · ⏱️ 13.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/django-restql) (📥 44K / month):
	```
...
- [GitHub](https://github.com/vitalik/django-ninja) (👨‍💻 170 · 🔀 530 · 📋 960 - 11% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/vitalik/django-ninja
	```
- [PyPi](https://pypi.org/project/django-ninja) (📥 1M / month):
	```
...
- [GitHub](https://github.com/eadwinCode/django-ninja-jwt) (👨‍💻 88 · 🔀 30 · 📦 500 · 📋 42 - 45% open · ⏱️ 20.10.2025):

	```
	git clone https://github.com/eadwinCode/django-ninja-jwt
	```
- [PyPi](https://pypi.org/project/django-ninja-jwt) (📥 100K / month):
	```
	pip install django-ninja-jwt
	```
</details>
<details><summary><b><a href="https://github.com/eadwinCode/django-ninja-extra">django-ninja-extra</a></b> (🥈23 ·  ⭐ 530) - Django Ninja Extra - Class-Based Utility and more for Django Ninja(Fast Django REST framework). <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/eadwinCode/django-ninja-extra) (👨‍💻 25 · 🔀 45 · 📋 99 - 19% open · ⏱️ 20.10.2025):

	```
	git clone https://github.com/eadwinCode/django-ninja-extra
	```
- [PyPi](https://pypi.org/project/django-ninja-extra) (📥 190K / month):
	```
...
- [GitHub](https://github.com/mawassk/django-ninja-apikey) (🔀 11 · 📦 7 · 📋 3 - 66% open · ⏱️ 27.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/django-ninja-apikey) (📥 2.2K / month):
	```
...
- [GitHub](https://github.com/pydantic/pydantic) (👨‍💻 650 · 🔀 2.3K · 📦 920K · 📋 5.4K - 9% open · ⏱️ 30.10.2025):
...
- [GitHub](https://github.com/jordaneremieff/djantic) (👨‍💻 4 · 🔀 33 · 📦 86 · 📋 41 - 31% open · ⏱️ 13.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/djantic) (📥 6.7K / month):
	```
	pip install djantic
	```
</details>
...
- [GitHub](https://github.com/yezz123/pyngo) (👨‍💻 8 · 🔀 8 · 📦 29 · ⏱️ 08.09.2025):
...
- [GitHub](https://github.com/chrisdev/django-pandas) (👨‍💻 36 · 🔀 120 · 📦 2.6K · 📋 86 - 17% open · ⏱️ 30.05.2025):
	...
	```
- [PyPi](https://pypi.org/project/django-pandas) (📥 160K / month):
	```
...
- [GitHub](https://github.com/mirumee/ariadne) (👨‍💻 85 · 🔀 190 · 📥 64 · 📦 2K · 📋 330 - 11% open · ⏱️ 13.10.2025):
...
- [GitHub](https://github.com/graphql-python/graphene-django) (👨‍💻 220 · 🔀 740 · 📦 16K · 📋 830 - 17% open · ⏱️ 23.06.2025):
	...
	```
- [PyPi](https://pypi.org/project/graphene-django) (📥 750K / month):
	```
...
- [GitHub](https://github.com/strawberry-graphql/strawberry) (👨‍💻 290 · 🔀 590 · 📥 460 · 📋 1.1K - 34% open · ⏱️ 30.10.2025):
...
- [GitHub](https://github.com/strawberry-graphql/strawberry-django) (👨‍💻 100 · 🔀 140 · 📋 380 - 26% open · ⏱️ 24.10.2025):

	```
	git clone https://github.com/strawberry-graphql/strawberry-graphql-django
	```
- [PyPi](https://pypi.org/project/strawberry-graphql-django) (📥 1.2M / month):
	```
...
- [GitHub](https://github.com/PedroBern/django-graphql-auth) (👨‍💻 16 · 🔀 100 · 📦 750 · 📋 100 - 58% open · ⏱️ 17.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/django-graphql-auth) (📥 5.3K / month):
	```
...
- [GitHub](https://github.com/django-waffle/django-waffle) (👨‍💻 120 · 🔀 240 · 📦 1.7K · 📋 220 - 18% open · ⏱️ 02.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/django-waffle) (📥 1.7M / month):
	```
...
- [GitHub](https://github.com/pytest-dev/pytest-django) (👨‍💻 150 · 🔀 340 · 📦 94K · 📋 560 - 28% open · ⏱️ 14.10.2025):

	```
	git clone https://github.com/pytest-dev/pytest-django
	```
- [PyPi](https://pypi.org/project/pytest-django) (📥 10M / month):
	```
...
- [GitHub](https://github.com/wemake-services/django-test-migrations) (👨‍💻 20 · 🔀 33 · 📦 1K · 📋 68 - 22% open · ⏱️ 31.10.2025):

	```
	git clone https://github.com/wemake-services/django-test-migrations
	```
- [PyPi](https://pypi.org/project/django-test-migrations) (📥 370K / month):
	```
...
- [GitHub](https://github.com/model-bakers/model_bakery) (👨‍💻 63 · 🔀 96 · 📋 150 - 16% open · ⏱️ 31.10.2025):

	```
	git clone https://github.com/model-bakers/model_bakery
	```
- [PyPi](https://pypi.org/project/model_bakery) (📥 1.2M / month):
	```
...
<details><summary><b><a href="https://github.com/zyskarch/pytestarch">PyTestArch</a></b> (🥇18 ·  ⭐ 130) - Test framework for software architecture based on imports between modules. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/zyskarch/pytestarch) (👨‍💻 11 · 🔀 9 · 📋 49 - 22% open · ⏱️ 22.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/pytestarch) (📥 52K / month):
	```
	pip install pytestarch
	```
</details>
<details><summary><b><a href="https://github.com/jwbargsten/pytest-archon">pytest-archon</a></b> (🥈16 ·  ⭐ 68) - Rule your architecture like a real developer. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/jwbargsten/pytest-archon) (👨‍💻 3 · 🔀 2 · 📦 42 · 📋 9 - 22% open · ⏱️ 19.09.2025):

	```
	git clone https://github.com/jwbargsten/pytest-archon
	```
- [PyPi](https://pypi.org/project/pytest-archon) (📥 710K / month):
	```
...
- [GitHub](https://github.com/fpgmaas/deptry) (👨‍💻 13 · 🔀 28 · 📦 1.7K · 📋 190 - 20% open · ⏱️ 29.10.2025):

	```
	git clone https://github.com/fpgmaas/deptry
	```
- [PyPi](https://pypi.org/project/deptry) (📥 2.9M / month):
	```
	pip install deptry
	```
</details>
...
<details><summary><b><a href="https://github.com/aboutcode-org/vulnerablecode">vulnerablecode</a></b> (🥇23 ·  ⭐ 640 · 📉) - A free and open vulnerabilities database and the packages they impact. And the tools to aggregate and correlate these.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/aboutcode-org/vulnerablecode) (👨‍💻 51 · 🔀 240 · 📥 520 · 📋 1.2K - 56% open · ⏱️ 02.10.2025):
...
- [GitHub](https://github.com/wagtail/wagtail) (👨‍💻 1K · 🔀 4.2K · 📦 12K · 📋 5.4K - 15% open · ⏱️ 29.10.2025):
...
- [GitHub](https://github.com/django-cms/django-cms) (👨‍💻 590 · 🔀 3.1K · 📦 5.5K · 📋 3.6K - 0% open · ⏱️ 31.10.2025):

	```
	git clone https://github.com/django-cms/django-cms
	```
- [PyPi](https://pypi.org/project/django-cms) (📥 92K / month):
	```
...
- [GitHub](https://github.com/stephenmcd/mezzanine) (👨‍💻 330 · 🔀 1.6K · 📦 2.5K · 📋 1.1K - 3% open · ⏱️ 06.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/mezzanine) (📥 12K / month):
	```
...
- [GitHub](https://github.com/django-oscar/django-oscar) (👨‍💻 380 · 🔀 2.2K · 📦 1.2K · 📋 1.5K - 6% open · ⏱️ 31.10.2025):

	```
	git clone https://github.com/django-oscar/django-oscar
	```
- [PyPi](https://pypi.org/project/django-oscar) (📥 46K / month):
	```
...
- [GitHub](https://github.com/saleor/saleor) (👨‍💻 320 · 🔀 5.7K · 📥 790 · 📦 8 · 📋 4.4K - 4% open · ⏱️ 31.10.2025):

	```
	git clone https://github.com/saleor/saleor
	```
- [PyPi](https://pypi.org/project/saleor) (📥 16 / month):
	```
	pip install saleor
	```
</details>
...
- [GitHub](https://github.com/awesto/django-shop) (👨‍💻 96 · 🔀 1K · 📦 230 · 📋 380 - 23% open · ⏱️ 28.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/django-shop) (📥 660 / month):
	```
...
- [GitHub](https://github.com/makeplane/plane) (👨‍💻 130 · 🔀 2.8K · 📥 89K · 📋 1.4K - 35% open · ⏱️ 31.10.2025):
...
- [GitHub](https://github.com/kaleidos-ventures/taiga) (👨‍💻 11 · 🔀 68 · ⏱️ 13.12.2023):
...
- [GitHub](https://github.com/getsentry/sentry) (👨‍💻 990 · 🔀 4.4K · 📥 6.2K · 📦 580 · 📋 16K - 10% open · ⏱️ 31.10.2025):
...
<details><summary><b><a href="https://github.com/DefectDojo/django-DefectDojo">DefectDojo</a></b> (🥇34 ·  ⭐ 4.3K) - Open-Source Unified Vulnerability Management, DevSecOps & ASPM. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/DefectDojo/django-DefectDojo) (👨‍💻 530 · 🔀 1.7K · 📥 660K · 📋 3.1K - 7% open · ⏱️ 30.10.2025):
...
<details><summary><b><a href="https://github.com/intelowlproject/IntelOwl">Intel owl</a></b> (🥉20 ·  ⭐ 4.3K) - IntelOwl: manage your Threat Intelligence at scale. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code></summary>

- [GitHub](https://github.com/intelowlproject/IntelOwl) (👨‍💻 70 · 🔀 500 · 📋 640 - 7% open · ⏱️ 20.05.2025):
...
<details><summary><b><a href="https://github.com/intuitem/ciso-assistant-community">CISO Assistant (Community Edition)</a></b> (🥇23 ·  ⭐ 3.3K) - CISO Assistant is a one-stop-shop for GRC, covering Risk, AppSec, Compliance/Audit Management, Privacy and supporting.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/intuitem/ciso-assistant-community) (👨‍💻 76 · 🔀 510 · 📋 500 - 16% open · ⏱️ 31.10.2025):
...
- [GitHub](https://github.com/jumpserver/jumpserver) (👨‍💻 180 · 🔀 5.5K · 📥 85K · 📦 21 · 📋 7.4K - 0% open · ⏱️ 31.10.2025):
...
- [GitHub](https://github.com/LibrePhotos/librephotos) (👨‍💻 78 · 🔀 370 · 📋 900 - 28% open · ⏱️ 22.10.2025):
...
<details><summary><b><a href="https://github.com/TandoorRecipes/recipes">Tandoor Recipes</a></b> (🥇25 ·  ⭐ 7.4K) - Application for managing recipes, planning meals, building shopping lists and much much more!. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/TandoorRecipes/recipes) (👨‍💻 440 · 🔀 710 · 📋 2.3K - 14% open · ⏱️ 15.10.2025):
...
<details><summary><b><a href="https://github.com/paperless-ngx/paperless-ngx">Paperless-ngx</a></b> (🥇32 ·  ⭐ 34K) - A community-supported supercharged document management system: scan, index and archive all your documents. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/paperless-ngx/paperless-ngx) (👨‍💻 420 · 🔀 2.1K · 📥 210K · ⏱️ 31.10.2025):
...
- [GitHub](https://github.com/openedx/edx-platform) (👨‍💻 1.5K · 🔀 3.8K · 📦 3 · 📋 900 - 31% open · ⏱️ 30.10.2025):
...
<details><summary><b><a href="https://github.com/inventree/InvenTree">InvenTree</a></b> (🥇30 ·  ⭐ 5.9K) - Open Source Inventory Management System. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/inventree/InvenTree) (👨‍💻 120 · 🔀 1.1K · 📥 2.2K · 📦 8 · 📋 3.1K - 4% open · ⏱️ 31.10.2025):
...
- [GitHub](https://github.com/netbox-community/netbox) (👨‍💻 430 · 🔀 2.8K · 📋 12K - 2% open · ⏱️ 31.10.2025):
...
- <b><a href="https://github.com/kernelci/dashboard">KernelCI (distributed test automation system focused on upstream kernel development) dashboard backend.</a></b> (🥈15 ·  ⭐ 6) - KernelCI web dashboard. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/georgemarshall/django-cryptography) (👨‍💻 4 · 🔀 78 · 📋 75 - 57% open · ⏱️ 16.02.2024):
	...
	```
- [PyPi](https://pypi.org/project/django-cryptography) (📥 220K / month):
	```
...
- [GitHub](https://github.com/stefanfoulis/django-phonenumber-field) (👨‍💻 120 · 🔀 300 · 📥 41 · 📦 32K · 📋 230 - 3% open · ⏱️ 06.10.2025):

	```
	git clone https://github.com/stefanfoulis/django-phonenumber-field
	```
- [PyPi](https://pypi.org/project/django-phonenumber-field) (📥 3M / month):
	```
...
<details><summary><b><a href="https://github.com/madisona/django-google-maps">django-google-maps</a></b> (🥈23 ·  ⭐ 280) - Using the Google Maps API with django model admin. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
- [GitHub](https://github.com/madisona/django-google-maps) (👨‍💻 20 · 🔀 96 · 📦 690 · 📋 47 - 25% open · ⏱️ 21.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/django-google-maps) (📥 33K / month):
	```
...
- [GitHub](https://github.com/openwisp/django-loci) (👨‍💻 32 · 🔀 46 · 📦 15 · 📋 46 - 4% open · ⏱️ 30.10.2025):
...
- [GitHub](https://github.com/simon-the-shark/django-mapbox-location-field) (👨‍💻 8 · 🔀 22 · 📦 600 · 📋 28 - 17% open · ⏱️ 20.06.2024):
	...
	```
- [PyPi](https://pypi.org/project/django-mapbox-location-field) (📥 2.2K / month):
	```
...
- [GitHub](https://github.com/django-commons/django-simple-history) (👨‍💻 190 · 🔀 470 · 📥 5 · 📦 7K · 📋 620 - 24% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/jazzband/django-simple-history
	```
- [PyPi](https://pypi.org/project/django-simple-history) (📥 2.4M / month):
	```
...
- [GitHub](https://github.com/jazzband/django-auditlog) (👨‍💻 97 · 🔀 400 · 📥 510 · 📦 1.7K · 📋 320 - 25% open · ⏱️ 31.10.2025):

	```
	git clone https://github.com/jazzband/django-auditlog
	```
- [PyPi](https://pypi.org/project/django-auditlog) (📥 680K / month):
	```
...
- [GitHub](https://github.com/soynatan/django-easy-audit) (👨‍💻 52 · 🔀 180 · 📦 370 · 📋 160 - 49% open · ⏱️ 18.10.2025):
...
<details><summary><b><a href="https://github.com/romgar/django-dirtyfields">django-dirtyfields</a></b> (🥉23 ·  ⭐ 650) - Tracking dirty fields on a Django model. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/romgar/django-dirtyfields) (👨‍💻 44 · 🔀 96 · 📦 690 · 📋 74 - 14% open · ⏱️ 09.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/django-dirtyfields) (📥 510K / month):
	```
...
- [GitHub](https://github.com/craigds/django-fieldsignals) (👨‍💻 5 · 🔀 11 · 📦 360 · 📋 17 - 17% open · ⏱️ 08.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/django-fieldsignals) (📥 41K / month):
	```
...
- [GitHub](https://github.com/stefanfoulis/django-sendsms) (👨‍💻 19 · 🔀 88 · 📦 390 · 📋 24 - 20% open · ⏱️ 27.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/django-sendsms) (📥 5.4K / month):
	```
...
- [GitHub](https://github.com/Ninjaclasher/django-discord-integration) (👨‍💻 2 · 🔀 1 · 📦 7 · 📋 3 - 33% open · ⏱️ 28.05.2024):
	...
	```
- [PyPi](https://pypi.org/project/django-discord-integration) (📥 960 / month):
	```
...
- [GitHub](https://github.com/jschneier/django-storages) (👨‍💻 280 · 🔀 840 · 📦 220K · 📋 750 - 15% open · ⏱️ 18.06.2025):
	...
	```
- [PyPi](https://pypi.org/project/django-storages) (📥 6.8M / month):
	```
...
- [GitHub](https://github.com/py-pa/django-minio-storage) (👨‍💻 18 · 🔀 55 · 📦 390 · 📋 86 - 11% open · ⏱️ 08.05.2025):
...
- [GitHub](https://github.com/pyeventsourcing/eventsourcing) (👨‍💻 28 · 🔀 140 · 📦 200 · 📋 100 - 2% open · ⏱️ 05.06.2025):
	...
	```
- [PyPi](https://pypi.org/project/eventsourcing) (📥 71K / month):
	```
...
- [GitHub](https://github.com/pyeventsourcing/eventsourcing-django) (👨‍💻 7 · 🔀 13 · 📦 10 · 📋 5 - 60% open · ⏱️ 09.06.2025):
	...
	```
- [PyPi](https://pypi.org/project/eventsourcing-django) (📥 2.9K / month):
	```
...
- [GitHub](https://github.com/pyeventsourcing/eventsourcing-kurrentdb) (👨‍💻 2 · 🔀 1 · ⏱️ 14.05.2025):
	...
	```
- [PyPi](https://pypi.org/project/eventsourcing-eventstoredb) (📥 380 / month):
	```
...
<details><summary><b><a href="https://github.com/ag2ai/faststream">FastStream</a></b> (🥇35 ·  ⭐ 4.7K) - FastStream is a powerful and easy-to-use asynchronous Python framework for building asynchronous services interacting.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/ag2ai/faststream) (👨‍💻 130 · 🔀 290 · 📦 760 · 📋 860 - 10% open · ⏱️ 31.10.2025):

	```
	git clone https://github.com/ag2ai/faststream
	```
- [PyPi](https://pypi.org/project/faststream) (📥 620K / month):
	```
...
- [GitHub](https://github.com/saxix/django-concurrency) (👨‍💻 27 · 🔀 51 · 📦 210 · 📋 77 - 1% open · ⏱️ 20.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/django-concurrency) (📥 97K / month):
	```
...
- [GitHub](https://github.com/davedash/django-fixture-magic) (👨‍💻 36 · 🔀 90 · 📦 170 · 📋 35 - 34% open · ⏱️ 26.10.2023):
...
- [GitHub](https://github.com/klen/mixer) (👨‍💻 43 · 🔀 92 · 📋 87 - 43% open · ⏱️ 23.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/mixer) (📥 160K / month):
	```
	pip install mixer
	```
</details>
...
- [GitHub](https://github.com/model-bakers/model_bakery) (👨‍💻 63 · 🔀 96 · 📋 150 - 16% open · ⏱️ 31.10.2025):
	...
	git clone https://github.com/model-bakers/model_bakery
	```
- [PyPi](https://pypi.org/project/model-bakery/) (📥 1.2M / month):
	```
...
- [GitHub](https://github.com/zostera/django-bootstrap4) (👨‍💻 140 · 🔀 220 · 📦 190K · 📋 160 - 10% open · ⏱️ 31.10.2025):

	```
	git clone https://github.com/zostera/django-bootstrap4
	```
- [PyPi](https://pypi.org/project/django-bootstrap4) (📥 270K / month):
	```
...
- [GitHub](https://github.com/zostera/django-bootstrap3) (👨‍💻 100 · 🔀 670 · 📦 19K · ⏱️ 19.10.2025):

	```
	git clone https://github.com/zostera/django-bootstrap3
	```
- [PyPi](https://pypi.org/project/django-bootstrap3) (📥 240K / month):
	```
...
- [GitHub](https://github.com/zostera/django-bootstrap5) (👨‍💻 150 · 🔀 89 · 📦 9.9K · 📋 110 - 34% open · ⏱️ 19.10.2025):

	```
	git clone https://github.com/zostera/django-bootstrap5
	```
- [PyPi](https://pypi.org/project/django-bootstrap5) (📥 270K / month):
	```
...
- [GitHub](https://github.com/zelenij/django-bootstrap-v5) (👨‍💻 140 · 🔀 42 · 📦 10K · 📋 24 - 33% open · ⏱️ 07.01.2024):
	...
	```
- [PyPi](https://pypi.org/project/django-bootstrap-v5) (📥 55K / month):
	```
...
<details><summary><b><a href="https://github.com/timonweb/django-bulma">django-bulma</a></b> (🥇19 ·  ⭐ 350) - Bulma theme for Django. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/timonweb/django-tailwind) (👨‍💻 23 · 🔀 110 · 📦 6.9K · 📋 180 - 0% open · ⏱️ 29.10.2025):
...
- [GitHub](https://github.com/django-commons/django-tailwind-cli) (👨‍💻 16 · 🔀 18 · 📥 110 · 📦 74 · 📋 42 - 7% open · ⏱️ 23.09.2025):

	```
	git clone https://github.com/oliverandrich/django-tailwind-cli
	```
- [PyPi](https://pypi.org/project/django-tailwind-cli) (📥 7.9K / month):
	```
...
- [GitHub](https://github.com/timonweb/pytailwindcss) (👨‍💻 3 · 🔀 10 · 📦 460 · 📋 12 - 8% open · ⏱️ 29.10.2025):

	```
	git clone https://github.com/timonweb/pytailwindcss
	```
- [PyPi](https://pypi.org/project/pytailwindcss) (📥 14K / month):
	```
...
- [GitHub](https://github.com/tolomea/django-data-browser) (👨‍💻 10 · 🔀 27 · 📦 42 · 📋 39 - 17% open · ⏱️ 09.04.2024):

	```
	git clone https://github.com/tolomea/django-data-browser
	```
- [PyPi](https://pypi.org/project/django-data-browser) (📥 5.9K / month):
	```
...
- [GitHub](https://github.com/django-tenants/django-tenants) (👨‍💻 120 · 🔀 370 · 📦 1.3K · 📋 700 - 35% open · ⏱️ 19.10.2025):

	```
	git clone https://github.com/django-tenants/django-tenants
	```
- [PyPi](https://pypi.org/project/django-tenants) (📥 370K / month):
	```
...
- [GitHub](https://github.com/bernardopires/django-tenant-schemas) (👨‍💻 76 · 🔀 400 · 📦 480 · 📋 480 - 26% open · ⏱️ 26.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/django-tenant-schemas) (📥 26K / month):
	```
	pip install django-tenant-schemas
	```
</details>
<details><summary><b><a href="https://github.com/citusdata/django-multitenant">django-multitenant</a></b> (🥉24 ·  ⭐ 790 · 💤) - Python/Django support for distributed multi-tenant databases like Postgres+Citus. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/citusdata/django-multitenant) (👨‍💻 27 · 🔀 120 · 📦 84 · 📋 99 - 43% open · ⏱️ 30.04.2024):
	...
	```
- [PyPi](https://pypi.org/project/django-multitenant) (📥 62K / month):
	```
...
- [GitHub](https://github.com/django-notifications/django-notifications) (👨‍💻 76 · 🔀 440 · 📦 3.1K · 📋 220 - 9% open · ⏱️ 17.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/django-notifications-hq) (📥 80K / month):
	```
...
<details><summary><b><a href="https://github.com/djaodjin/djaodjin-saas">djaodjin-saas</a></b> (🥇17 ·  ⭐ 600) - Django application for software-as-service and subscription businesses. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/djaodjin/djaodjin-saas) (👨‍💻 14 · 🔀 130 · 📦 12 · 📋 110 - 12% open · ⏱️ 17.10.2025):

	```
	git clone https://github.com/djaodjin/djaodjin-saas
	```
- [PyPi](https://pypi.org/project/djaodjin-saas) (📥 890 / month):
	```
...
- [GitHub](https://github.com/dj-stripe/dj-stripe) (👨‍💻 130 · 🔀 500 · 📦 1.2K · 📋 1.1K - 5% open · ⏱️ 15.10.2025):
...
- [GitHub](https://github.com/spookylukey/django-paypal) (👨‍💻 73 · 🔀 200 · 📦 4.2K · 📋 170 - 8% open · ⏱️ 18.11.2024):
	...
	```
- [PyPi](https://pypi.org/project/django-paypal) (📥 26K / month):
	```
...
- [GitHub](https://github.com/jazzband/django-payments) (👨‍💻 71 · 🔀 280 · 📥 31 · 📦 660 · 📋 190 - 37% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/jazzband/django-payments
	```
- [PyPi](https://pypi.org/project/django-payments) (📥 10K / month):
	```
...
- [GitHub](https://github.com/django-getpaid/django-getpaid) (👨‍💻 31 · 🔀 100 · 📦 49 · 📋 62 - 6% open · ⏱️ 12.03.2025):
	...
	```
- [PyPi](https://pypi.org/project/django-getpaid) (📥 7.6K / month):
	```
...
- [GitHub](https://github.com/pinax/pinax-stripe-light) (👨‍💻 72 · 🔀 270 · 📋 300 - 22% open · ⏱️ 28.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pinax-stripe-light) (📥 64 / month):
	```
...
- [GitHub](https://github.com/kogan/django-subscriptions) (👨‍💻 2 · 🔀 9 · 📦 19 · ⏱️ 29.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/django-subscriptions) (📥 19K / month):
	```
	pip install django-subscriptions
	```
</details>
<details><summary><b><a href="https://github.com/silverapp/silver">silver</a></b> (🥉15 ·  ⭐ 310 · 📉) - Automated billing and payments for Django with a REST API. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/paddle-python/dj-paddle) (👨‍💻 7 · 🔀 33 · 📋 25 - 56% open · ⏱️ 26.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/dj-paddle) (📥 59 / month):
	```
	pip install dj-paddle
	```
</details>
<details><summary><b><a href="https://github.com/oscarychen/drf-stripe-subscription">drf-stripe-subscription</a></b> (🥉11 ·  ⭐ 120) - An out-of-box Django REST framework solution for payment and subscription management using Stripe. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/oscarychen/drf-stripe-subscription) (👨‍💻 7 · 🔀 18 · 📋 25 - 20% open · ⏱️ 20.08.2025):

	```
	git clone https://github.com/oscarychen/drf-stripe-subscription
	```
- [PyPi](https://pypi.org/project/drf-stripe-subscription) (📥 960 / month):
	```
...
<details><summary><b><a href="https://github.com/anymail/django-anymail">django-anymail</a></b> (🥇30 ·  ⭐ 1.8K) - Django email backends and webhooks for Amazon SES, Brevo (Sendinblue), MailerSend, Mailgun, Mailjet, Postmark, Postal,.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/django-ses/django-ses) (👨‍💻 85 · 🔀 220 · 📦 3.6K · 📋 150 - 32% open · ⏱️ 15.10.2025):

	```
	git clone https://github.com/django-ses/django-ses
	```
- [PyPi](https://pypi.org/project/django-ses) (📥 920K / month):
	```
...
- [GitHub](https://github.com/coddingtonbear/django-mailbox) (👨‍💻 55 · 🔀 160 · 📦 230 · 📋 160 - 12% open · ⏱️ 20.06.2025):
	...
	```
- [PyPi](https://pypi.org/project/django-mailbox) (📥 24K / month):
	```
...
- [GitHub](https://github.com/aio-libs/aiosmtpd) (👨‍💻 45 · 🔀 97 · 📥 600 · 📋 180 - 38% open · ⏱️ 18.06.2025):
...
- [GitHub](https://github.com/django-components/django-components) (👨‍💻 54 · 🔀 100 · 📋 340 - 23% open · ⏱️ 21.10.2025):

	```
	git clone https://github.com/django-components/django-components
	```
- [PyPi](https://pypi.org/project/django-components) (📥 77K / month):
	```
	pip install django-components
	```
</details>
<details><summary><b><a href="https://github.com/wrabit/django-cotton">wrabit/django-cotton</a></b> (🥈26 ·  ⭐ 1K) - Enabling Modern UI Composition in Django. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/wrabit/django-cotton) (👨‍💻 13 · 🔀 46 · 📦 280 · 📋 110 - 1% open · ⏱️ 31.10.2025):

	```
	git clone https://github.com/wrabit/django-cotton
	```
- [PyPi](https://pypi.org/project/django-cotton) (📥 84K / month):
	```
...
- [GitHub](https://github.com/django-compressor/django-compressor) (👨‍💻 220 · 🔀 570 · 📋 670 - 17% open · ⏱️ 12.10.2025):

	```
	git clone https://github.com/django-compressor/django-compressor
	```
- [PyPi](https://pypi.org/project/django-compressor) (📥 1.5M / month):
	```
...
- [GitHub](https://github.com/adamchainz/django-htmx) (👨‍💻 25 · 🔀 150 · 📋 92 - 6% open · ⏱️ 31.10.2025):

	```
	git clone https://github.com/adamchainz/django-htmx
	```
- [PyPi](https://pypi.org/project/django-htmx) (📥 640K / month):
	```
...
- [GitHub](https://github.com/carltongibson/django-template-partials) (👨‍💻 18 · 🔀 32 · 📦 360 · ⏱️ 17.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/django-template-partials) (📥 100K / month):
	```
	pip install django-template-partials
	```
</details>
<details><summary><b><a href="https://github.com/inertiajs/inertia-django">inertia-django</a></b> (🥉19 ·  ⭐ 500) - The Django adapter for Inertia.js. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/inertiajs/inertia-django) (👨‍💻 17 · 🔀 46 · 📦 150 · 📋 43 - 11% open · ⏱️ 05.10.2025):
...
- [GitHub](https://github.com/wemake-services/wemake-django-template) (👨‍💻 55 · 🔀 220 · 📋 550 - 4% open · ⏱️ 31.10.2025):
...
<details><summary><b><a href="https://github.com/apptension/saas-boilerplate">saas-boilerplate</a></b> (🥇18 ·  ⭐ 2.7K) - SaaS Boilerplate - Open Source and free SaaS stack that lets you build SaaS products faster in React, Django and AWS... <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/apptension/saas-boilerplate) (👨‍💻 41 · 🔀 370 · 📋 200 - 23% open · ⏱️ 09.03.2025):
...
<details><summary><b><a href="https://github.com/Healthlane-Technologies/Zango">Zango</a></b> (🥈14 ·  ⭐ 340) - Django meta-framework for building enterprise-ready custom business applications. <code>❗Unlicensed</code></summary>
...
<details><summary><b><a href="https://github.com/jefftriplett/django-startproject">django-startproject</a></b> (🥈12 ·  ⭐ 270) - Django Start Project template with batteries. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/evansd/whitenoise) (👨‍💻 70 · 🔀 150 · 📦 530K · 📋 250 - 10% open · ⏱️ 10.10.2025):

	```
	git clone https://github.com/evansd/whitenoise
	```
- [PyPi](https://pypi.org/project/whitenoise) (📥 6.3M / month):
	```
...
- [GitHub](https://github.com/jcugat/django-custom-user) (👨‍💻 12 · 🔀 59 · 📦 290 · 📋 24 - 4% open · ⏱️ 09.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/django-custom-user) (📥 28K / month):
	```
...
- [GitHub](https://github.com/jambonrose/django-improved-user) (👨‍💻 8 · 🔀 14 · 📦 44 · 📋 11 - 9% open · ⏱️ 08.08.2024):
	...
	```
- [PyPi](https://pypi.org/project/django-improved-user) (📥 2.1K / month):
	```
...
- [GitHub](https://github.com/jmfederico/django-use-email-as-username) (👨‍💻 3 · 🔀 11 · 📦 320 · ⏱️ 08.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/django-use-email-as-username) (📥 3.1K / month):
	```
...
- [GitHub](https://github.com/carltongibson/django-unique-user-email) (👨‍💻 4 · 🔀 6 · 📦 17 · 📋 10 - 60% open · ⏱️ 09.10.2024):
	...
	```
- [PyPi](https://pypi.org/project/django-unique-user-email) (📥 2.3K / month):
	```
...
<details><summary><b><a href="https://github.com/tomvictor/iotcore">iotcore</a></b> (🥇12 ·  ⭐ 52 · 💤) - MQTT Broker and IoT Capabilities written in Rust for Python, Django and FastAPI. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/tomvictor/iotcore) (👨‍💻 2 · 🔀 6 · 📦 4 · 📋 4 - 25% open · ⏱️ 01.02.2024):
	...
	```
- [PyPi](https://pypi.org/project/iotcore) (📥 1.1K / month):
	```
	pip install iotcore
	```
</details>
...
<details><summary><b><a href="https://github.com/emmett-framework/granian">granian</a></b> (🥇31 ·  ⭐ 4.5K) - A Rust HTTP server for Python applications. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/emmett-framework/granian) (👨‍💻 38 · 🔀 130 · 📦 790 · 📋 290 - 9% open · ⏱️ 29.10.2025):

	```
	git clone https://github.com/emmett-framework/granian
	```
- [PyPi](https://pypi.org/project/granian) (📥 620K / month):
	```
	pip install granian
	```
</details>
...
- [GitHub](https://github.com/openwisp/openwisp-monitoring) (👨‍💻 27 · 🔀 140 · 📦 5 · 📋 300 - 13% open · ⏱️ 30.10.2025):
