...
- [Authentication and Authorization](#authentication-and-authorization) _13 projects_
...
- [GitHub](https://github.com/fabiocaccamo/django-admin-interface) (👨‍💻 32 · 🔀 140 · 📦 3.1K · 📋 180 - 8% open · ⏱️ 18.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-admin-interface) (📥 68K / month):
	```
...
- [GitHub](https://github.com/jazzband/django-admin-sortable) (👨‍💻 80 · 🔀 130 · 📦 640 · 📋 140 - 6% open · ⏱️ 13.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/django-admin-sortable) (📥 74K / month):
	```
...
- [GitHub](https://github.com/wemake-services/django-split-settings) (👨‍💻 23 · 🔀 61 · 📦 2.1K · 📋 44 - 9% open · ⏱️ 31.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-split-settings) (📥 88K / month):
	```
...
- [GitHub](https://github.com/fabiocaccamo/django-extra-settings) (👨‍💻 12 · 🔀 25 · 📦 52 · 📋 24 - 4% open · ⏱️ 18.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-extra-settings) (📥 7.4K / month):
	```
...
- [GitHub](https://github.com/snok/django-guid) (👨‍💻 8 · 🔀 19 · 📦 98 · 📋 24 - 16% open · ⏱️ 16.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-guid) (📥 77K / month):
	```
...
- [GitHub](https://github.com/python-social-auth/social-app-django) (👨‍💻 320 · 🔀 340 · 📦 33K · 📋 270 - 46% open · ⏱️ 01.08.2023):
...
<details><summary><b><a href="https://github.com/jazzband/django-oauth-toolkit">django-oauth-toolkit</a></b> (🥈27 ·  ⭐ 2.9K · ➕) - OAuth2 goodies for the Djangonauts!. <code>❗Unlicensed</code></summary>
...
<details><summary><b><a href="https://github.com/juanifioren/django-oidc-provider">django-oidc-provider</a></b> (🥈27 ·  ⭐ 370 · ➕) - OpenID Connect and OAuth2 provider implementation for Djangonauts. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/snok/django-auth-adfs) (👨‍💻 44 · 🔀 85 · 📦 99 · 📋 170 - 9% open · ⏱️ 15.07.2023):

	```
	git clone https://github.com/snok/django-auth-adfs
	```
- [PyPi](https://pypi.org/project/django-auth-adfs) (📥 32K / month):
	```
...
- [GitHub](https://github.com/bennylope/django-organizations) (👨‍💻 47 · 🔀 190 · 📋 150 - 10% open · ⏱️ 23.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-organizations) (📥 34K / month):
	```
...
- [GitHub](https://github.com/caffeinehit/django-oauth2-provider) (👨‍💻 16 · 🔀 180 · 📦 20 · 📋 65 - 61% open · ⏱️ 03.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-oauth2-provider) (📥 6.1K / month):
	```
...
- [GitHub](https://github.com/idlesign/django-oauthost) (👨‍💻 2 · 📦 2 · 📋 3 - 33% open · ⏱️ 04.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/django-oauthost) (📥 150 / month):
	```
...
- [GitHub](https://github.com/rq/rq) (👨‍💻 300 · 🔀 1.3K · 📦 14K · 📋 1.1K - 13% open · ⏱️ 21.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/rq) (📥 950K / month):
	```
	pip install rq
	```
</details>
...
- [GitHub](https://github.com/jazzband/django-fsm-log) (👨‍💻 26 · 🔀 67 · 📦 130 · 📋 45 - 24% open · ⏱️ 26.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-fsm-log) (📥 32K / month):
	```
...
- [GitHub](https://github.com/gadventures/django-fsm-admin) (👨‍💻 32 · 🔀 82 · 📦 320 · 📋 38 - 47% open · ⏱️ 25.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/django-fsm-admin) (📥 85K / month):
	```
...
- [GitHub](https://github.com/eadwinCode/django-ninja-jwt) (👨‍💻 78 · 🔀 8 · 📦 75 · ⏱️ 09.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-ninja-jwt) (📥 9.2K / month):
	```
...
<details><summary><b><a href="https://github.com/mawassk/django-ninja-apikey">django-ninja-apikey</a></b> (🥉13 ·  ⭐ 22 · 💤) - Easy to use API key authentication for Django Ninja REST Framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/pydantic/pydantic) (👨‍💻 390 · 🔀 1.3K · 📦 230K · 📋 2.9K - 11% open · ⏱️ 01.08.2023):

	```
	git clone https://github.com/pydantic/pydantic
	```
- [PyPi](https://pypi.org/project/pydantic) (📥 83M / month):
	```
...
- [GitHub](https://github.com/strawberry-graphql/strawberry-graphql-django) (👨‍💻 50 · 🔀 71 · 📦 300 · 📋 170 - 25% open · ⏱️ 31.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/strawberry-graphql-django) (📥 49K / month):
	```
...
- [GitHub](https://github.com/model-bakers/model_bakery) (👨‍💻 46 · 🔀 79 · 📦 3.1K · 📋 120 - 20% open · ⏱️ 04.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/model_bakery) (📥 400K / month):
	```
...
- [GitHub](https://github.com/wemake-services/django-test-migrations) (👨‍💻 18 · 🔀 27 · 📦 590 · 📋 60 - 21% open · ⏱️ 11.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-test-migrations) (📥 94K / month):
	```
...
- [GitHub](https://github.com/revsys/django-test-plus) (👨‍💻 33 · 🔀 59 · 📋 56 - 17% open · ⏱️ 11.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-test-plus) (📥 56K / month):
	```
...
- [GitHub](https://github.com/saleor/saleor) (👨‍💻 280 · 🔀 4.9K · 📥 15 · 📦 1 · 📋 3.8K - 13% open · ⏱️ 31.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/saleor) (📥 30 / month):
	```
	pip install saleor
	```
</details>
...
- [GitHub](https://github.com/orcasgit/django-fernet-fields) (👨‍💻 9 · 🔀 55 · 📦 620 · 📋 16 - 62% open · ⏱️ 10.05.2019):
	...
	```
- [PyPi](https://pypi.org/project/django-fernet-fields) (📥 71K / month):
	```
...
- [GitHub](https://github.com/georgemarshall/django-cryptography) (👨‍💻 4 · 🔀 54 · 📋 68 - 52% open · ⏱️ 19.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-cryptography) (📥 83K / month):
	```
...
- [GitHub](https://github.com/stefanfoulis/django-phonenumber-field) (👨‍💻 110 · 🔀 290 · 📥 13 · 📦 22K · 📋 210 - 3% open · ⏱️ 22.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-phonenumber-field) (📥 700K / month):
	```
...
- [GitHub](https://github.com/VeryApt/django-phone-field) (👨‍💻 4 · 🔀 14 · 📦 2.8K · 📋 14 - 21% open · ⏱️ 10.06.2020):
	...
	```
- [PyPi](https://pypi.org/project/django-phone-field) (📥 14K / month):
	```
...
- [GitHub](https://github.com/madisona/django-google-maps) (👨‍💻 19 · 🔀 92 · 📦 580 · 📋 46 - 26% open · ⏱️ 22.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/django-google-maps) (📥 5.4K / month):
	```
...
- [GitHub](https://github.com/jazzband/django-auditlog) (👨‍💻 68 · 🔀 330 · 📥 300 · 📦 710 · 📋 240 - 21% open · ⏱️ 17.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-auditlog) (📥 180K / month):
	```
...
- [GitHub](https://github.com/soynatan/django-easy-audit) (👨‍💻 45 · 🔀 140 · 📦 190 · 📋 130 - 46% open · ⏱️ 13.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-easy-audit) (📥 39K / month):
	```
...
- [GitHub](https://github.com/lamby/django-slack) (👨‍💻 28 · 🔀 55 · 📦 350 · 📋 63 - 14% open · ⏱️ 02.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-slack) (📥 58K / month):
	```
...
- [GitHub](https://github.com/maddevsio/django_minio) (👨‍💻 4 · 🔀 15 · 📋 5 - 20% open · ⏱️ 02.04.2019):
	...
	```
- [PyPi](https://pypi.org/project/django-minio) (📥 260 / month):
	```
...
- [GitHub](https://github.com/gavinwahl/django-optimistic-lock) (👨‍💻 4 · 🔀 21 · 📦 12 · 📋 5 - 20% open · ⏱️ 02.01.2019):
	...
	```
- [PyPi](https://pypi.org/project/django-optimistic-lock) (📥 4.3K / month):
	```
...
- [GitHub](https://github.com/model-bakers/model_bakery) (👨‍💻 46 · 🔀 79 · 📦 3.1K · 📋 120 - 20% open · ⏱️ 04.07.2023):
	...
	git clone https://github.com/model-bakers/model_bakery
	```
- [PyPi](https://pypi.org/project/model-bakery/) (📥 400K / month):
	```
...
- [GitHub](https://github.com/zostera/django-bootstrap5) (👨‍💻 140 · 🔀 52 · 📦 3.8K · 📋 79 - 43% open · ⏱️ 29.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-bootstrap5) (📥 45K / month):
	```
...
- [GitHub](https://github.com/timonweb/django-tailwind) (👨‍💻 18 · 🔀 82 · 📦 2.2K · 📋 140 - 5% open · ⏱️ 22.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-tailwind) (📥 36K / month):
	```
...
- [GitHub](https://github.com/raphaelm/django-scopes) (👨‍💻 6 · 🔀 15 · 📦 53 · 📋 16 - 62% open · ⏱️ 12.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-scopes) (📥 2.9K / month):
	```
